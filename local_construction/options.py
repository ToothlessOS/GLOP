...
def get_options(args=None):
    ...
    # Data
    parser.add_argument('--problem', default='local', help="The problem to solve, default 'local'")
    parser.add_argument('--graph_size', type=int, default=10, help="The size of the problem graph")
    parser.add_argument('--batch_size', type=int, default=512, help='Number of instances per batch during training') #512
    ...
    # Misc
    parser.add_argument('--log_step', type=int, default=250, help='Log info every log_step steps')
