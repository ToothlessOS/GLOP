...
def train_epoch(
    ...
    if train_dataset is not None:
        ...
        training_dataloader = DataLoader(
            training_dataset, batch_size=opts.batch_size, num_workers=0, shuffle=True
        )
    else:
        ...
        training_dataloader = DataLoader(
            training_dataset, batch_size=opts.batch_size, num_workers=1, shuffle=False
        )
...
def train_batch(
    ...
    # Note(26.8.11): Check the rollout from both endpoints; Data augmentation
