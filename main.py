...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_connection_revision', action='store_true',
                        help='After every chunk-revision iteration, run a '
                             'connection-revision pass on the boundaries '
                             'between adjacent sub-tours.')
